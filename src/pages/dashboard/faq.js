        ...
        <m.div
            ...
            <Card sx={ isDesktop ? { p: 4, backgroundColor: "grey.100" } : { p: 2, backgroundColor: "grey.100" }}>
                ...
                <Accordion expanded={expanded === 'panel5'} onChange={handleChange('panel5')}>
                    ...
                    <AccordionDetails>
                    <Typography component="p" sx={{ mb: 1}}>While the term &rdquo;meeting&rdquo; traditionally refers to a face-to-face interaction, in the context of AI, it can be understood as interacting with the AI system. So, while you can&rsquo;t physically meet AI personal directors (as they are not human and don&rsquo;t possess a physical form), you can certainly interact with them via the Personal Board platform.</Typography><Typography component="p" sx={{ mb: 1}}>You can think of these interactions as a form of meeting, in which you present your challenges, goals, or questions to the AI directors and receive their guidance and advice in return. Just like a physical meeting, these interactions can be scheduled at your convenience, and the AI directors are available 24/7 to provide their expertise.</Typography><Typography component="p" sx={{ mb: 1}}>Remember that while AI personal directors are sophisticated algorithms capable of generating impressive and useful advice, they do not possess consciousness or subjective experiences. They do not &rdquo;know&rdquo; you in the human sense, but they analyze the data you provide to generate relevant and personalized advice.</Typography><Typography component="p" sx={{ mb: 1}}>In this sense, your &rdquo;meeting&rdquo; with AI personal directors is a unique interaction tailored to your specific needs, providing you with the benefit of diverse expertise at any time.</Typography>
                    </AccordionDetails>
                </Accordion>
